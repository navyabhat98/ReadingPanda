    ...
    <div class="LoginForm">   
            <div class="container">
                ...
                <div class="login-form">
                    <div class="main-div">
                        <div class="panel">
                            <h1  style="font-family:cursive;"><font color="#ff3333"><center>INSERT</center></font></h1>
                            <br>
                            <br>
                         </div>
                         <ul>
                         <li><a href="inslang.jsp"><button style="background-color:#ff5c33" class="btn"><b> INSERT INTO LANGUAGE</b></button></a></li>
                         <br>
						<li><a href="insmood.jsp"><button style="background-color:#ff5c33" class="btn"><b>INSERT INTO MOOD</b></button></a></li>
						<br>
						<li><a href="insgenre.jsp"><button style="background-color:#ff5c33" class="btn"><b>INSERT INTO GENRE</b></button></a></li>
						<br>
						<li><a href="insauth.jsp"><button style="background-color:#ff5c33" class="btn"><b>INSERT INTO AUTHOR</b></button></a></li>
						<br>
						<li><a href="insbook.jsp"><button style="background-color:#ff5c33" class="btn"><b>INSERT INTO BOOK</b></button></a></li>
...
ResultSet rs4=st4.executeQuery("select * from author");
