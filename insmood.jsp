...
.navbar-right {
    ...
    <div class="LoginForm">   
            <div class="container">
                ...
                <div class="login-form">
                    <div class="main-div">
                        <div class="panel">
                            <h1  style="font-family:cursive;"><font color="#ff3333">INSERT MOOD</font></h1>
                            <br>
                            
                         </div>
        	<form id="Login" name="f1" method="POST" action="insmood.jsp">
        	<div class="form-group">
           <font color="#ff3333"> MOOD ID:</font>  <input type="text" name="M_ID" value=""> <br>
            </div>
            <div class="form-group">
            <font color="#ff3333">MOOD NAME:</font> <input type="text" name="M_NAME" value=""> <br>
            </div>
  ...
  if(M_ID!=null && M_NAME!=null) {
	  try{
						...
						ps1 = con.prepareStatement("INSERT INTO MOOD VALUES(?,?)");
		               ps1.setString(1, M_ID);    //set the first paremter to language ID
