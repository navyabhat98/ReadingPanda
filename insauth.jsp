    					...
    					<div class="LoginForm">   
            				<div class="container">
                				<div class="login-form">
                    				<div class="main-div">
                        				<div class="panel">
                            				<h1  style="font-family:cursive;"><font color="#ff3333">INSERT AUTHOR</font></h1>
                         				</div>
        								<form id="Login" name="f1" method="POST" action="insauth.jsp">
        								<div class="form-group">
           									<font color="#ff3333"> AUTHOR ID:</font>  <input type="text" name="A_ID" value=""> <br>
            							</div>
            						<div class="form-group">
            							<font color="#ff3333">AUTHOR NAME:</font> <input type="text" name="AUTHOR_NAME" value=""> <br>
            						</div>
									<%
										...
										result = statement.executeQuery("select * from language") ;
									%>
    								<font color="#ff3333">L_ID:</font>
        							<select name="L_ID">
        							<%  while(result.next()){ %>
            						<option><%= result.getString("L_ID")%></option>
        							<% } %>
        							</select>
									<%  
        								String s=request.getParameter("L_ID");
  										if(A_ID!=null && AUTHOR_NAME!=null && s!=null) {
	  										try{
    											PreparedStatement ps1 = null;
												ps1 = con.prepareStatement("INSERT INTO AUTHOR VALUES(?,?,?)");
		               							ps1.setString(1, A_ID);   
		              							ps1.setString(2, AUTHOR_NAME);
		               							ps1.setString(3,s);
