    			...
    			<div class="LoginForm">   
            		<div class="container">                   
                		<div class="login-form">
                    		<div class="main-div">
                        		<div class="panel">
                            		<h1  style="font-family:cursive;"><font color="#ff3333">DELETE</font></h1>
                         		</div>
        						<form id="Login" name="f1" method="POST" action="delete.jsp">
					...
					<%  
  						if(B_ID!=null) {
	  						try{
								...
								ps1 = con.prepareStatement("DELETE FROM BOOK WHERE(B_ID=?)");
