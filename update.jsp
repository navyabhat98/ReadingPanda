    ...
    <div class="LoginForm">   
            <div class="container">
                ...
                <div class="login-form">
                    <div class="main-div">
                        <div class="panel">
                            <h1  style="font-family:cursive;"><font color="#ff3333">UPDATE</font></h1>
                         </div>
        	<form id="Login" name="f1" method="POST" action="update.jsp">
        	<div class="form-group">
           <font color="#ff3333">B_ID</font>  <input type="text" name="B_ID" value=""> <br>
            </div>
            <div class="form-group">
           <font color="#ff3333"> BOOK_NAME:</font>  <input type="text" name="BOOK_NAME" value=""> <br>
            </div>
...
<%  
  if(BOOK_NAME!=null && B_ID!=null) {
	  PreparedStatement ps = null;     
      try {
               ps = con.prepareStatement("update book set BOOK_NAME=? where B_ID=?");                            
               ps.setString(1, BOOK_NAME);    //set the first paremter to language ID
              // ps.setString(2, lid1);
               ps.setString(2, B_ID);
