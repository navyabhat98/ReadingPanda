         	...
         	<div class="LoginForm">   
            	<div class="container">                   
                	<div class="login-form">
                    	<div class="main-div">
                        	<div class="panel">
                            	<h2  style="font-family:cursive;">Choose your favourite Genre</h2>                               
                         	</div>
                         	<form id="Login" name="f1" method="POST" action="genre1.jsp">
                            	<div class="form-group">
                                	Genre name: <input type="text" class="form-control" name="G_NAME">
                                </div>
								<%
			...
			<%  
  				if(G_NAME!=null) {
	  				try{
						...
						ps1 = con.prepareStatement("SELECT G_ID FROM GENRE WHERE G_NAME=?");
		                ps1.setString(1, G_NAME);    //set the first paremter to language ID		           
		                result=ps1.executeQuery();		              
		            	result.next();
		                String str = result.getString("G_ID");		               
	  				}catch(Exception e) { }
	  				try{
		                PreparedStatement ps2=null;       
		                ps2=con.prepareStatement("select distinct book_name from book b,genre g where b.g_id=?");  
