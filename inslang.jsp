...
.navbar-right {
    ...
    <div class="LoginForm">   
            <div class="container">
                ...
                <div class="login-form">
                    <div class="main-div">
                        <div class="panel">
                            <h1  style="font-family:cursive;"><font color="#ff3333">INSERT LANGUAGE</font></h1>
                            <br>
                         </div>
        	<form id="Login" name="f1" method="POST" action="inslang.jsp">
        	<div class="form-group">
           <font color="#ff3333"> LANGUAGE ID:</font>  <input type="text" name="L_ID" value=""> <br>
            </div>
            <div class="form-group">
            <font color="#ff3333">LANGUAGE NAME:</font> <input type="text" name="L_NAME" value=""> <br>
            </div>
  ...
  if(L_ID!=null && L_NAME!=null) {
	  try{
						...
						ps1 = con.prepareStatement("INSERT INTO LANGUAGE VALUES(?,?)");
		               ps1.setString(1, L_ID);    //set the first paremter to language ID
		              ps1.setString(2, L_NAME);
